...
4. (Opsional tapi direkomendasikan) Python 3 + pandas + openpyxl untuk ekspor ke Excel.
5. Akses ke folder project: `project/` di mana file KTR, SQL, dan hasil akan disimpan.
